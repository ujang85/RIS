 ...
 *
 * @property IDENTIFICATION[] $eNTIFICATIONs
 */
class PASIEN extends \yii\db\ActiveRecord
{
     ...
     */
    public function getENTIFICATIONs()
    {
        return $this->hasMany(IDENTIFICATION::className(), ['NO_REGISTRATION' => 'NO_REGISTRATION']);
    }
