 ...
 */
class KunjunganPasienSearch extends PasienVisitation
{
    /**
     * {@inheritdoc}
     */
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'ORG_UNIT_CODE', $this->ORG_UNIT_CODE])
            ...
            ->andFilterWhere(['like', 'NAME_OF_PASIEN', $this->NO_REGISTRATION])
